...
//{
//    public class ProgramFirebaseAdminAuth
//    {
...
//                    await new ProgramFirebaseAdminAuth().SendNotification(new List<string>() { deviceId, deviceId }, "title", "body: some sort of msg to be sent to a device!");
