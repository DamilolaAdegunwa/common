...
namespace CodeSnippet.ConsoleApp.XMLComments2
{
    /*
The main Math class
...
synchronized.
If you've followed this tutorial and applied the tags to your code where necessary, your code should now look
